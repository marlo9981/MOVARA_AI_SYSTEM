...
See detailed decision tree: `05_ASSETS_TEMPLATES/MCP_INTEGRATIONS/MODEL_ROUTING_GUIDE.md`
...
- **Full integration guide:** `/05_ASSETS_TEMPLATES/MCP_INTEGRATIONS/MCP_STACK.md`
- **Model routing guide:** `/05_ASSETS_TEMPLATES/MCP_INTEGRATIONS/MODEL_ROUTING_GUIDE.md`
- **Cost tracking:** `/06_METRICS_DASHBOARDS/API-Usage-Tracker.md`
- **Agent preferences:** `/05_ASSETS_TEMPLATES/AGENT_CATALOG.md`
